    ...
    <Layout>
      <AboutContainer>
        ...
        <Row className="reverse">
          ...
          <TextCol>
            <p>
              <strong>Анастасия Тиханвич</strong> – артистка эстрады
            </p>
          </TextCol>
          <Gap></Gap>
        </Row>
        ...
        <p>
          Наш проект <em>
            возраждает приоритетные ценности культуры и формирует 
        ...
        <p>
          ...
          художественные образы постичь глубину Православного мировозрения и
          <em>христианское отношение к окружающему миру</em>.
        </p>
        ...
        <p>
          ...
          музыкальные гостиные, музыкально — поэтического вечера, тематические 
        ...
        <p>
          Творчеству композитора В.Козбанова и творческой группы «Тимпан»
